...
class TestMobileAvailableConfig(TestCase):
    """
    Tests MobileAvailableConfig
    """

    def test_ignore_mobile_available_flag(self):
        MobileAvailableConfig(mobile_available_override=True).save()
        should_ignore_flag = MobileAvailableConfig.ignore_mobile_available_flag()
